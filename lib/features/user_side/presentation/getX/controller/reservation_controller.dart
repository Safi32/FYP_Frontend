...
//   // // Save restaurant ID when user selects a restaurant
//   // Future<void> saveRestaurantId(int id) async {
//   //   final prefs = await SharedPreferences.getInstance();
//   //   await prefs.setInt('restaurant_id', id);
//   //   print("Restaurant ID saved: $id");
//   // }

//   // Fetch restaurant ID dynamically when making a reservation
...
//     // Dynamically fetch restaurant ID before submission
